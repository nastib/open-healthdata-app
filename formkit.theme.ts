...
/**
  ...
  *
  * @checksum - 6a5ad6bd609c1e780f522c35eae0ba78a10fbda707aac939a0e5c127d20ede45
  * @variables - radius=rounded,accentColor=yellow,colorTemperature=slate,spacing=1.5,scale=sm,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
